			...
			$(function () {
				...
				if(parseInt("${user.role}")==1){
					data=[{
					    ...
					    {id: '03',text: '我要请假', icon: 'fa fa-gg',url: 'tHoliday/stuHolidayHtml.htm'}
				...
				if(parseInt("${user.role}")==2){
					data=[{
					    ...
					    {id: '03',text: '请假管理', icon: 'fa fa-gg',url: 'tHoliday/teaHolidayHtml.htm'},
				...
				if(parseInt("${user.role}")==3){
					data=[{
					    ...
					    {id: '04',text: '请假管理', icon: 'fa fa-file-text-o',url: 'tHoliday/adminHolidayHtml.htm'}
					    ]
				}
